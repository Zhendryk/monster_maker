...
class Ui_MonsterCreationView(object):
    def setupUi(self, MonsterCreationView):
        ...
        MonsterCreationView.resize(468, 1042)
        ...
        self.gl_ability_scores.addWidget(self._lbl_dex, 0, 2, 1, 1)
        self._lbl_con = QtWidgets.QLabel(MonsterCreationView)
        self._lbl_con.setObjectName("_lbl_con")
        self.gl_ability_scores.addWidget(self._lbl_con, 0, 4, 1, 1)
        ...
        self.gl_ability_scores.addWidget(self.spinbox_dex, 0, 3, 1, 1)
        ...
        self.gl_ability_scores.addWidget(self.spinbox_con, 0, 5, 1, 1)
        ...
        self.gl_ability_scores.addWidget(self._lbl_wis, 1, 2, 1, 1)
        ...
        self.gl_ability_scores.addWidget(self.spinbox_wis, 1, 3, 1, 1)
        self._lbl_cha = QtWidgets.QLabel(MonsterCreationView)
        self._lbl_cha.setObjectName("_lbl_cha")
        self.gl_ability_scores.addWidget(self._lbl_cha, 1, 4, 1, 1)
        ...
        self.gl_ability_scores.addWidget(self.spinbox_cha, 1, 5, 1, 1)
